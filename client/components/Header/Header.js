...
const tipDoc = (<div className="title-container">
  ...
  <p>初次使用，强烈建议你阅读 <a target="_blank" href="http://yapi.qunar.com" rel="noopener noreferrer">使用文档</a>
    ...
    <ul>
      ...
      >
        <Tooltip placement="bottom" title={'使用文档'}>
          <li className="toolbar-li">
            <a target="_blank" href="#" rel="noopener noreferrer"><Icon
      ...
      <Header className="header-box m-header">
        <div className="content g-row">
          <Link onClick={this.relieveLink} to="/group" className="logo">
            <div className="href">
              <span className="img"><img className="img" src={getImgPath('/image/logo', 'png')} /></span>
